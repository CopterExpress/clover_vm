...
echo 'target_include_directories(sitl_gazebo PUBLIC "/home/clover/PX4-Autopilot/build/px4_sitl_default/mavlink")' >> ~/catkin_ws/src/clover/clover_simulation/CMakeLists.txt
cd ~/catkin_ws
catkin_make
